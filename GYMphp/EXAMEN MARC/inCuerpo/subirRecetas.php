...
<div class="container">
    ...
    <?php    
        ...
        if(isset($_POST['NuevaReceta'])){//the "name" of the button submit. Recoge los valores del formulario
        ...
        //comprobamos si el TITULO YA EXISTE O NO:
            ...
            if ($resultado!=1) {                        
                //header("Location: inCuerpo/subirRecetas.php?codigoERROR=1");
                header("Location: index.php?codigoERROR=1");
        ...
        //comprobamos si LA EXTENCIÓN es .txt
            ...
            if ($resultadoExtencion!=0) {
                ...
                //header("Location: inCuerpo/subirRecetas.php?codigoERROR=2");
                //include("inCuerpo/subirRecetas.php?codigoERROR=2");
                header("Location: index.php?codigoERROR=2");
            }              
            ...
            echo $Receta;
                ...
                {//si se ha subido el fichero de la Receta ….                                  
                    ...
                    {  //si se ha subido el fichero Foto….                
                        ...
                        if ($fotoOk==0) {
                            //header("Location: inCuerpo/subirRecetas.php?codigoERROR=3");
                            include("inCuerpo/subirRecetas.php?codigoERROR=3");
                        }
                        //echo $extension;
                        ...
                        //header("Location: inCuerpo/subirRecetas.php?codigoERROR=4");
                        header("Location: index.php?codigoERROR=4");                             
                    }
        ...
        //Pintamos el resumen del resultado aquí:
        ...
        ?>
                        <div class="mainTitle">
                            ...
                            <div class='newProduct'>                             
                                <strong>CON EL NOMBRE: <?php echo $Titulo ?></strong>
                                
                                <br><br>
                                
                                <strong>En la carpeta: </strong>
                                <?php echo $estacion ?>
                                <br><br>
                                
                                <strong>El texto del archivo: </strong>
                                    <?php
            ...
            ?>
                <div class="">            
                    ...
                    <form action="index.php" method="POST" ENCTYPE="multipart/form-data">        
                            ...
                            <br>                
                            <br> 
                            <input type="submit" name="NuevaReceta" value="NuevaReceta" >Añadir Nueva Recta</button>
