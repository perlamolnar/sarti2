            ...
            <?php
                ...
                foreach ($ficheros as $nombreFichero) {    //recorremos el array para ver sus elementos: expresión_array as $valor       
                    ...
                    if ($nombreFichero!="." && $nombreFichero!="..") {           
                        ...
                        echo "<a href=\"#\" onclick=\"cargarContenido('$nombreFichero', 'verano')\";>".substr($nombreFichero, 0, -4)."</a><br>"; //pintar receta en la misma pagina en un div
                        //usamos la substr() function para quitar el .txt al final de nombre de fichero

                        echo "<a href=\"#\" onclick=\"cargarContenido('$nombreFichero', 'verano')\";><img src=\"img/".substr($nombreFichero, 0, -4).".jpg\"></a><br>";
