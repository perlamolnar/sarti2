<form class="navbarmenu" action="index.php" method ="post"> 
	<ul>
		...
		<?php
 		...
 		?>
		<li><button class="navbarbut" value="loggin"name="seccio" type="submit">Iniciar Sesión</button></li>
		...
		<li><button class="navbarbut" value="unloggin" name="seccio" type="submit">Cerrar Sesión</button></li>
		<?php
		}
		?>	
	</ul>
