...
<form id="upload" action="index.php" method="post" enctype="multipart/form-data">
	...
	<input class="radioBtn" type="radio" name="sec" value="pelis" CHECKED>Peli
	<input class="radioBtn" type="radio" name="sec" value="series">Serie
	<input class="radioBtn" type="radio" name="sec" value="libros">Libro
